...
def _upload_to_aws_s3(list_of_files_to_be_uploaded_to_s3: List[str], aws_s3_location: Path):
    ...
    client = boto3.client('s3',
                            aws_access_key_id = g.settings.connections.aws_access_key_id,
                            aws_secret_access_key = g.settings.connections.aws_secret_access_key)
    ...
    for file in list_of_files_to_be_uploaded_to_s3:
        ...
        client.upload_file(file, g.settings.connections.s3_bucket_name, str(upload_file_key))
