...
def _import_author(g: GitentialContext, author: dict, workspace_id: int):
    try:
        aliases = _import_aliases(g, author["email"], workspace_id=workspace_id)
        ...
        g.backend.authors.create(workspace_id, author_create)
